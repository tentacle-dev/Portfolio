...
const About = (props) => {
  return (
    <div className='body pb-2' id="about">
      <h1 className='text-center text-white text-3xl pb-2 underline-hover uppercase underline decoration-sky-500'>About Me</h1>
      <div className='md:grid md:grid-cols-12 mx-8'>
        <div className=' col-span-7 text-white mx-8 my-8 text-justify inline '>
            ...
            for some time but I thought of filling it with something So I earned a degree in software engineering, and web design and development are my passions. I have a solid background in coding languages including HTML, CSS, and JavaScript as well as practical knowledge of front-end frameworks like React.
            I am familiar with database systems like SQL and NoSQL
