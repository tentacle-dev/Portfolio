...
const project = (props) => {
  return (    
    <section id='projects'>
       ...
       <Modal name='my-modal-1' img={props.img} navigate="https://github.com/tentacle-dev/Portfolio"/>
        ...
        <Modal name='my-modal-2' img={props.img} navigate="https://github.com/tentacle-dev/Portfolio"/>
          <div>
            <img src={props.img} className="rounded-xl border-2 proj-img img m-auto " alt="Thanush" />
        ...
        <Modal name='my-modal-3' img={props.img} navigate="https://github.com/tentacle-dev/Portfolio"/>
          <img src={props.img} className="rounded-xl border-2 proj-img img m-auto " alt="Thanush" />
